...
defcolor_cursor_write = managed_id_declare(app, string_u8_litexpr("colors"), string_u8_litexpr("defcolor_cursor_write"));
defcolor_at_cursor_write = managed_id_declare(app, string_u8_litexpr("colors"), string_u8_litexpr("defcolor_at_cursor_write"));
defcolor_margin_active_write = managed_id_declare(app, string_u8_litexpr("colors"), string_u8_litexpr("defcolor_margin_active_write"));
